...
const TestimonialsSection: React.FC = () => {
  ...
  const beforeAfterPairs = [
    ...
    { 
      ...
      after: '/images/Augenbrauen_Microblading.webp' 
    },
    { 
      before: '/images/Augenbrauen_undicht.webp', 
      after: '/images/Augenbrauen_Model.webp' 
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg group">
                <div className="h-96 w-full transition-all duration-700 ease-in-out transform group-hover:scale-105">
                  <OptimizedImage 
                    ...
                    alt={`Vor der Augenbrauentransplantation - Patient mit lückigen Augenbrauen vor der Behandlung`}
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg group">
                <div className="h-96 w-full transition-all duration-700 ease-in-out transform group-hover:scale-105">
                  <OptimizedImage 
                    ...
                    alt={`Nach der Augenbrauentransplantation - Erfolgreiche Behandlung mit vollen Augenbrauen`}
                    className="w-full h-full object-cover"
                    loading="lazy"
                  />
                </div>
