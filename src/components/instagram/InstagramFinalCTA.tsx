    ...
    <section className="py-16 bg-gradient-to-br from-[#7BA7C2] to-[#5A8BA6] text-white">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Starten Sie jetzt Ihre Haartransplantation!
        </h2>
        <p className="text-xl mb-8 opacity-90">
          Kostenlose Beratung und individuelle Behandlungsplanung
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <button
            onClick={() => onWhatsAppContact('Hallo! Ich komme von Instagram und interessiere mich für eine Haartransplantation. Bitte beraten Sie mich kostenlos zu Ihren Behandlungen.')}
