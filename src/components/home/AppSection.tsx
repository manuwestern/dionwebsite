            ...
            <div className="bg-gradient-to-br from-[#7BA7C2] to-[#7BA7C2]/70 rounded-3xl p-1 shadow-xl max-w-sm mx-auto">
              <div className="bg-white rounded-3xl overflow-hidden">
                ...
                <div className="p-4">
                  {/* Progress tracker */}
                  <div className="mb-6">
                    <h4 className={`${fontSize.sm} ${textColor.light} mb-2`}>{t('appSection.appContent.progress')}</h4>
                    <div className="w-full bg-gray-100 h-2 rounded-full">
                      <div className="bg-[#7BA7C2] h-2 rounded-full w-[65%]"></div>
                    </div>
                    <div className="flex justify-between text-xs text-gray-500 mt-1">
                      <span>{t('appSection.appContent.day1')}</span>
                      <span>{t('appSection.appContent.month3')}</span>
                      <span>{t('appSection.appContent.month12')}</span>
                    </div>
                  </div>
                  
                  {/* Today's tasks */}
                  <div className="mb-6">
                    <h4 className={`${fontSize.sm} ${fontWeight.medium} ${textColor.dark} mb-2`}>{t('appSection.appContent.todayTasks')}</h4>
                    <div className="space-y-2">
                      <div className="flex items-center p-2 bg-[#7BA7C2]/5 rounded-lg">
                        ...
                        <span className={`${fontSize.sm}`}>{t('appSection.appContent.task1')}</span>
                      </div>
                      <div className="flex items-center p-2 bg-[#7BA7C2]/5 rounded-lg">
                        <div className="w-5 h-5 rounded-full border-2 border-[#7BA7C2] flex items-center justify-center mr-2">
                          <div className="w-2 h-2 bg-[#7BA7C2] rounded-full"></div>
                        </div>
                        <span className={`${fontSize.sm}`}>{t('appSection.appContent.task2')}</span>
                      </div>
                      <div className="flex items-center p-2 bg-gray-50 rounded-lg">
                        <div className="w-5 h-5 rounded-full border-2 border-gray-300 mr-2"></div>
                        <span className={`${fontSize.sm} ${textColor.light}`}>{t('appSection.appContent.task3')}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#7BA7C2]/10 p-3 rounded-xl">
                    <h4 className={`${fontSize.sm} ${fontWeight.medium} ${textColor.primary} mb-1`}>{t('appSection.appContent.nextAppointment')}</h4>
                    <p className={`${fontSize.sm}`}>{t('appSection.appContent.appointmentDetails')}</p>
                  </div>
                </div>
              </div>
            </div>
