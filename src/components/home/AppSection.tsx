      ...
      <div className="w-full max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-3">
            <h2 className={`${textStyle.sectionTitle} text-3xl md:text-4xl lg:text-5xl leading-tight md:leading-snug lg:leading-normal px-2 md:px-0 hyphens-auto break-words`} lang="de">{t('appSection.title')}</h2>
