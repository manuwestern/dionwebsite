      ...
      <div className="w-full max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-block mb-4 relative">
            ...
            <h2 className={`${textStyle.sectionTitle} text-3xl md:text-4xl lg:text-5xl leading-tight md:leading-snug lg:leading-normal px-2 md:px-0 hyphens-auto break-words`} lang="de">{t('testimonialsSection.title')}</h2>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg group">
                <div className="h-96 w-full transition-all duration-700 ease-in-out transform group-hover:scale-105">
                  <OptimizedImage 
                    ...
                    alt={`Vor der Haartransplantation - Patient mit Haarausfall vor der Behandlung`}
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg group">
                <div className="h-96 w-full transition-all duration-700 ease-in-out transform group-hover:scale-105">
                  <OptimizedImage 
                    ...
                    alt={`Nach der Haartransplantation - Erfolgreiche Behandlung mit sichtbaren Ergebnissen`}
                    className="w-full h-full object-cover"
                    loading="lazy"
                  />
                </div>
