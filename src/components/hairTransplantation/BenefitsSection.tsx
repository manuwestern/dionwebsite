          ...
          {benefitCards.map((card, index) => (
            ...
            >
              <div className="flex flex-col h-full">
                {/* Fixed height header with icon and title in the same row */}
                <div className="w-full p-4 bg-[#7BA7C2] h-[60px] flex items-center">
                ...
                <div className="p-6 flex-grow bg-gradient-to-b from-gray-50 to-white">
                  {/* Description text */}
